...
class Su_Generator {
    ...
    private static function GetOptionByAttr($attr_name, $attr_info) {    	
    	...
    	$return = '<div class="su-generator-field-container' .$field_type . '" data-default="' . htmlentities($default) . '">';
	...
	public static function settings() { {
	   ...
	   // Shortcode has atts
		...
		// Wrapping shortcode
			...
			$return .= '<div class="su-generator-field-container"><h5>' . JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_CONTENT') . '</h5><textarea name="su-generator-content" id="su-generator-content" rows="5">' . str_replace( array( '%prefix_', '__' ), su_cmpt(), $shortcode['content'] ) . '</textarea></div>';
