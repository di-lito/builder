...
class Su_Shortcode_twitter extends Su_Shortcodes {
    ...
    public static function twitter($atts = null, $content = null) {
        ...
        if (isset($data)) {
            ...
            return su_alert_box(JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_TWITTER_ERROR'), 'warning'); // Please set your twitter API key properly in your shortcode ultimate plugin settings.
        }
    }
