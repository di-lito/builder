...
class SppagebuilderAddonSu_gmap_advanced extends SppagebuilderAddons{
	...
	public function render(){
		...
		$zoom_control_style  = (isset($this->addon->settings->zoom_control_style) && $this->addon->settings->zoom_control_style) ? $this->addon->settings->zoom_control_style : '';
		$custom_marker       = (isset($this->addon->settings->custom_marker) && $this->addon->settings->custom_marker) ? $this->addon->settings->custom_marker : '';
