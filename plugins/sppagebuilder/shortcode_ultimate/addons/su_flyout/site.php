...
class SppagebuilderAddonSu_flyout extends SppagebuilderAddons{
	...
	public function render(){
		...
		$dimension      = (isset($this->addon->settings->dimension) && $this->addon->settings->dimension) ? $this->addon->settings->dimension : '';
		$position       = (isset($this->addon->settings->position) && $this->addon->settings->position) ? $this->addon->settings->position : '';
		$transition_in  = (isset($this->addon->settings->transition_in) && $this->addon->settings->transition_in) ? $this->addon->settings->transition_in : '';
		$transition_out = (isset($this->addon->settings->transition_out) && $this->addon->settings->transition_out) ? $this->addon->settings->transition_out : '';
		$close_style    = (isset($this->addon->settings->close_style) && $this->addon->settings->close_style) ? $this->addon->settings->close_style : '';
