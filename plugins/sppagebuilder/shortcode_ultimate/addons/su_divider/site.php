...
class SppagebuilderAddonSu_divider extends SppagebuilderAddons{
	...
	public function render(){
		...
		$visible         = (isset($this->addon->settings->visible) && $this->addon->settings->visible) ? $this->addon->settings->visible : '';
		$hidden          = (isset($this->addon->settings->hidden) && $this->addon->settings->hidden) ? $this->addon->settings->hidden : '';
