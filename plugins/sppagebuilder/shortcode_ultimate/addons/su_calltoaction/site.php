...
class SppagebuilderAddonSu_calltoaction extends SppagebuilderAddons{
	...
	public function render(){
		...
		$button_background       = (isset($this->addon->settings->button_background) && $this->addon->settings->button_background) ? $this->addon->settings->button_background : '';
		$button_background_hover = (isset($this->addon->settings->button_background_hover) && $this->addon->settings->button_background_hover) ? $this->addon->settings->button_background_hover : '';
		$button_radius           = (isset($this->addon->settings->button_radius) && $this->addon->settings->button_radius) ? $this->addon->settings->button_radius : '';
