...
class SppagebuilderAddonSu_flip_box extends SppagebuilderAddons{
	...
	public function render(){
		...
		$animation_style = (isset($this->addon->settings->animation_style) && $this->addon->settings->animation_style) ? $this->addon->settings->animation_style : '';
		$ff_text_align   = (isset($this->addon->settings->ff_text_align) && $this->addon->settings->ff_text_align) ? $this->addon->settings->ff_text_align : '';
		$fb_text_align   = (isset($this->addon->settings->fb_text_align) && $this->addon->settings->fb_text_align) ? $this->addon->settings->fb_text_align : '';
