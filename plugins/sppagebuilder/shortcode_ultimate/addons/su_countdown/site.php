...
class SppagebuilderAddonSu_countdown extends SppagebuilderAddons{
	...
	public function render(){
		...
		$count_time    = (isset($this->addon->settings->count_time) && $this->addon->settings->count_time) ? $this->addon->settings->count_time : '';
		...
		$divider       = (isset($this->addon->settings->divider) && $this->addon->settings->divider) ? $this->addon->settings->divider : '';
