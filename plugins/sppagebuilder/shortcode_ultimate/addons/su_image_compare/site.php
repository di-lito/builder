...
class SppagebuilderAddonSu_image_compare extends SppagebuilderAddons{
	...
	public function render(){
		...
		$before_image = (isset($this->addon->settings->before_image) && $this->addon->settings->before_image) ? $this->addon->settings->before_image : '';
		$after_image  = (isset($this->addon->settings->after_image) && $this->addon->settings->after_image) ? $this->addon->settings->after_image : '';
		$orientation  = (isset($this->addon->settings->orientation) && $this->addon->settings->orientation) ? $this->addon->settings->orientation : '';
		$slide_on     = (isset($this->addon->settings->slide_on) && $this->addon->settings->slide_on) ? $this->addon->settings->slide_on : '';
