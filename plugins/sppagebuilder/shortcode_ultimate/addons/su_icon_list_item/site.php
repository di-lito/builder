...
class SppagebuilderAddonSu_icon_list_item extends SppagebuilderAddons{
	...
	public function render(){
		...
		$title_color     = (isset($this->addon->settings->title_color) && $this->addon->settings->title_color) ? $this->addon->settings->title_color : '';
		$title_size      = (isset($this->addon->settings->title_size) && $this->addon->settings->title_size) ? $this->addon->settings->title_size : '';
		$icon_color      = (isset($this->addon->settings->icon_color) && $this->addon->settings->icon_color) ? $this->addon->settings->icon_color : '';
		$icon_animation  = (isset($this->addon->settings->icon_animation) && $this->addon->settings->icon_animation) ? $this->addon->settings->icon_animation : '';
		$icon_border     = (isset($this->addon->settings->icon_border) && $this->addon->settings->icon_border) ? $this->addon->settings->icon_border : '';
		$icon_shadow     = (isset($this->addon->settings->icon_shadow) && $this->addon->settings->icon_shadow) ? $this->addon->settings->icon_shadow : '';
		$icon_radius     = (isset($this->addon->settings->icon_radius) && $this->addon->settings->icon_radius) ? $this->addon->settings->icon_radius : '';
		$icon_align      = (isset($this->addon->settings->icon_align) && $this->addon->settings->icon_align) ? $this->addon->settings->icon_align : '';
		...
		$linkto          = (isset($this->addon->settings->linkto) && $this->addon->settings->linkto) ? $this->addon->settings->linkto : '';
