...
class SppagebuilderAddonSu_flipbook extends SppagebuilderAddons{
	...
	public function render(){
		...
		$type         = (isset($this->addon->settings->fb_type) && $this->addon->settings->fb_type) ? $this->addon->settings->fb_type : '';
		$title        = (isset($this->addon->settings->title) && $this->addon->settings->title) ? $this->addon->settings->title : '';
		$tags         = (isset($this->addon->settings->tags) && $this->addon->settings->tags) ? $this->addon->settings->tags : '';
