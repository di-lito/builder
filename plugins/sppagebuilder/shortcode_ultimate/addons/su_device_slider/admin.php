			...
			'attr'=>array(
				'general' => array(
	                ...
	                'dir_path'  => array(
						'type'        => 'text',
						'title'       => 'Directory',
						'placeholder' => 'images/sampledata/gallery',
						'desc'        => 'Write your images directory/folder path to the input box, for example: images/sampledata/gallery',
						'depends'     => array(
	                ...
	                'med_library'  => array(
						...
						'desc'        => 'Type image url. Use comma for saperating multiple image, e.g: images/01.jpg,images/02.jpg',
						'depends'     => array(
							'source_type' => 'media',
						),
	                ),
