...
class SppagebuilderAddonSu_progress_pie extends SppagebuilderAddons{
	...
	public function render(){
		...
		$before     = (isset($this->addon->settings->before) && $this->addon->settings->before) ? $this->addon->settings->before : '';
		$text       = (isset($this->addon->settings->text) && $this->addon->settings->text) ? $this->addon->settings->text : '';
		$after      = (isset($this->addon->settings->after) && $this->addon->settings->after) ? $this->addon->settings->after : '';
		$text_size  = (isset($this->addon->settings->text_size) && $this->addon->settings->text_size) ? $this->addon->settings->text_size : '';
		$line_width = (isset($this->addon->settings->line_width) && $this->addon->settings->line_width) ? $this->addon->settings->line_width : '';
		$line_cap   = (isset($this->addon->settings->line_cap) && $this->addon->settings->line_cap) ? $this->addon->settings->line_cap : '';
		$bar_color  = (isset($this->addon->settings->bar_color) && $this->addon->settings->bar_color) ? $this->addon->settings->bar_color : '';
		$fill_color = (isset($this->addon->settings->fill_color) && $this->addon->settings->fill_color) ? $this->addon->settings->fill_color : '';
		$text_color = (isset($this->addon->settings->text_color) && $this->addon->settings->text_color) ? $this->addon->settings->text_color : '';
		$animation  = (isset($this->addon->settings->animation) && $this->addon->settings->animation) ? $this->addon->settings->animation : '';
