...
class SppagebuilderAddonSu_instagram extends SppagebuilderAddons{
	...
	public function render(){
		...
		$instagram_id    = (isset($this->addon->settings->instagram_id) && $this->addon->settings->instagram_id) ? $this->addon->settings->instagram_id : '';
		$hash_tag        = (isset($this->addon->settings->hash_tag) && $this->addon->settings->hash_tag) ? $this->addon->settings->hash_tag : '';
		$instagram_token = (isset($this->addon->settings->instagram_token) && $this->addon->settings->instagram_token) ? $this->addon->settings->instagram_token : '';
		$link_type       = (isset($this->addon->settings->link_type) && $this->addon->settings->link_type) ? $this->addon->settings->link_type : '';
