...
class SppagebuilderAddonSu_file_download extends SppagebuilderAddons{
	...
	public function render(){
		...
		$custom_title            = (isset($this->addon->settings->custom_title) && $this->addon->settings->custom_title) ? $this->addon->settings->custom_title : '';
		$save_as                 = (isset($this->addon->settings->save_as) && $this->addon->settings->save_as) ? $this->addon->settings->save_as : '';
		$button_class            = (isset($this->addon->settings->button_class) && $this->addon->settings->button_class) ? $this->addon->settings->button_class : '';
