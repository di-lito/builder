...
class SppagebuilderAddonSu_counter extends SppagebuilderAddons{
	...
	public function render(){
		...
		$icon_color    = (isset($this->addon->settings->icon_co && $this->addon->settings->icon_colorl ? $this->addon->settings->icon_color : ''or));
		$count_color   = (isset($this->addon->settings->count_c && $this->addon->settings->count_coloro ? $this->addon->settings->count_color : ''lor));
