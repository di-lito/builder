...
class SppagebuilderAddonSu_blockquote extends SppagebuilderAddons{
	...
	public function render(){
		...
		$font    = (isset($this->addon->settings->font) && $this->addon->settings->font) ? $this->addon->settings->font : '';;
		$cite    = (isset($this->addon->settings->cite) && $this->addon->settings->cite) ? $this->addon->settings->cite : '';;
