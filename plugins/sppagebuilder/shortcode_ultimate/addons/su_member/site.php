...
class SppagebuilderAddonSu_member extends SppagebuilderAddons{
	...
	public function render(){
		...
		$icon_1_title = (isset($this->addon->settings->icon_1_title) && $this->addon->settings->icon_1_title) ? $this->addon->settings->icon_1_title : '';
		$icon_2_title = (isset($this->addon->settings->icon_2_title) && $this->addon->settings->icon_2_title) ? $this->addon->settings->icon_2_title : '';
		$icon_3_title = (isset($this->addon->settings->icon_3_title) && $this->addon->settings->icon_3_title) ? $this->addon->settings->icon_3_title : '';
		$icon_4_title = (isset($this->addon->settings->icon_4_title) && $this->addon->settings->icon_4_title) ? $this->addon->settings->icon_4_title : '';
		$icon_5_title = (isset($this->addon->settings->icon_5_title) && $this->addon->settings->icon_5_title) ? $this->addon->settings->icon_5_title : '';
		$icon_6_title = (isset($this->addon->settings->icon_6_title) && $this->addon->settings->icon_6_title) ? $this->addon->settings->icon_6_title : '';
		$icon_1_url   = (isset($this->addon->settings->icon_1_url) && $this->addon->settings->icon_1_url) ? $this->addon->settings->icon_1_url : '';
		$icon_2_url   = (isset($this->addon->settings->icon_2_url) && $this->addon->settings->icon_2_url) ? $this->addon->settings->icon_2_url : '';
		$icon_3_url   = (isset($this->addon->settings->icon_3_url) && $this->addon->settings->icon_3_url) ? $this->addon->settings->icon_3_url : '';
		$icon_4_url   = (isset($this->addon->settings->icon_4_url) && $this->addon->settings->icon_4_url) ? $this->addon->settings->icon_4_url : '';
		$icon_5_url   = (isset($this->addon->settings->icon_5_url) && $this->addon->settings->icon_5_url) ? $this->addon->settings->icon_5_url : '';
		$icon_6_url   = (isset($this->addon->settings->icon_6_url) && $this->addon->settings->icon_6_url) ? $this->addon->settings->icon_6_url : '';
