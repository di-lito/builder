...
class SppagebuilderAddonSu_showcase extends SppagebuilderAddons{
	...
	public function render(){
		...
		$show_more_action      = (isset($this->addon->settings->show_more_action) && $this->addon->settings->show_more_action) ? $this->addon->settings->show_more_action : '';
		...
		$loading_animation     = (isset($this->addon->settings->loading_animation) && $this->addon->settings->loading_animation) ? $this->addon->settings->loading_animation : '';
		$filter_animation      = (isset($this->addon->settings->filter_animation) && $this->addon->settings->filter_animation) ? $this->addon->settings->filter_animation : '';
		$caption_style         = (isset($this->addon->settings->caption_style) && $this->addon->settings->caption_style) ? $this->addon->settings->caption_style : '';
		$filter_style          = (isset($this->addon->settings->filter_style) && $this->addon->settings->filter_style) ? $this->addon->settings->filter_style : '';
		$filter_align          = (isset($this->addon->settings->filter_align) && $this->addon->settings->filter_align) ? $this->addon->settings->filter_align : '';
		$item_link             = (isset($this->addon->settings->item_link) && $this->addon->settings->item_link) ? $this->addon->settings->item_link : '';
		$popup_position        = (isset($this->addon->settings->popup_position) && $this->addon->settings->popup_position) ? $this->addon->settings->popup_position : '';
