...
class SppagebuilderAddonSu_content_slider extends SppagebuilderAddons{
	...
	public function render(){
		...
		$transitionin   = (isset($this->addon->settings->transitionin) && $this->addon->settings->transitionin) ? $this->addon->settings->transitionin : '';
		$transitionout  = (isset($this->addon->settings->transitionout) && $this->addon->settings->transitionout) ? $this->addon->settings->transitionout : '';
		$arrow_position = (isset($this->addon->settings->arrow_position) && $this->addon->settings->arrow_position) ? $this->addon->settings->arrow_position : '';
