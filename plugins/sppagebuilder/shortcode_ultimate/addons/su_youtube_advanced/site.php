...
class SppagebuilderAddonSu_youtube_advanced extends SppagebuilderAddons{
	...
	public function render(){
		...
		$playlist       = (isset($this->addon->settings->playlist) && $this->addon->settings->playlist) ? $this->addon->settings->playlist : '';
		$controls       = (isset($this->addon->settings->controls) && $this->addon->settings->controls) ? $this->addon->settings->controls : '';
		$autohide       = (isset($this->addon->settings->autohide) && $this->addon->settings->autohide) ? $this->addon->settings->autohide : '';
		$theme          = (isset($this->addon->settings->theme) && $this->addon->settings->theme) ? $this->addon->settings->theme : '';
		$wmode          = (isset($this->addon->settings->wmode) && $this->addon->settings->wmode) ? $this->addon->settings->wmode : '';
