	...
	if(is_object($options->section_height)){
		if(isset($options->section_height->md) && $options->section_height->md){
			if($options->section_height_option=='height'){
				...
				$sec_cont_style .= '#'. $row_id . ' .sppb-section-content-center {min-height:'.$options->section_height->md.'px;}';
			}
		}
		...
		if (isset($options->section_height->sm) && $options->section_height->sm){
			if($options->section_height_option=='height'){
				...
				$sec_cont_style_sm .= '#'. $row_id . ' .sppb-section-content-center {min-height:'.$options->section_height->sm.'px;}';
			}
		}
		...
		if (isset($options->section_height->xs) && $options->section_height->xs){
			if($options->section_height_option=='height'){
				...
				$sec_cont_style_xs .= '#'. $row_id . ' .sppb-section-content-center {min-height:'.$options->section_height->xs.'px;}';
			}
		}
	} else {
		if ($options->section_height) {
			if($options->section_height_option=='height'){
				...
				$sec_cont_style .= '#'. $row_id . ' .sppb-section-content-center {min-height:'.$options->section_height.'px;}';
			}
		}
	}
}
...
if(isset($options->section_height_option) && $options->section_height_option=='win-height'){
	...
	$sec_cont_window_style .= '#'. $row_id . ' .sppb-section-content-center {min-height: 100vh;}';
}
...
if($sec_cont_window_style) {
	$row_styles .= $sec_cont_window_style;
}
if($sec_cont_style) {
	$row_styles .= $sec_cont_style;
}

if($sec_cont_style_sm) {
	$row_styles .=  '@media (min-width: 768px) and (max-width: 991px) {' . $sec_cont_style_sm . '}';
}
if($sec_cont_style_xs) {
	$row_styles .= '@media (max-width: 767px) {' . $sec_cont_style_xs . '}';
}
