...
class SppagebuilderAddonTestimonial extends SppagebuilderAddons {
	...
	public function css() {
		...
		$style .= (isset($settings->review_margin) && $settings->review_margin) ? "margin: " . $settings->review_margin . ";" : "";
		...
		$avatar_margin = (isset($settings->avatar_margin) && $settings->avatar_margin) ? $settings->avatar_margin : '';
		...
		$rating_style .= (isset($settings->client_rating_margin) && $settings->client_rating_margin) ? 'margin:'.$settings->client_rating_margin.';' : '';
		if($rating_style){
		...
		$style_sm .= (isset($settings->review_margin_sm) && $settings->review_margin_sm) ? "margin: " . $settings->review_margin_sm . ";" : "";
		//Name tablet Style
		$name_style_sm = '';
		...
		//Avatar tablet style
		$avatar_margin_sm = (isset($settings->avatar_margin_sm) && $settings->avatar_margin_sm) ? $settings->avatar_margin_sm : '';
		//Rating tablet style
		$rating_style_sm = '';
		...
		$style_xs .= (isset($settings->review_margin_xs) && $settings->review_margin_xs) ? "margin: " . $settings->review_margin_xs . ";" : "";
		...
		//Avatar mobile style
		$avatar_margin_xs = (isset($settings->avatar_margin_xs) && $settings->avatar_margin_xs) ? $settings->avatar_margin_xs : '';
		//Rating tablet style
		$rating_style_xs = '';
