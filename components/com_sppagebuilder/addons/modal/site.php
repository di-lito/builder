	...
	public function css() {
		...
		if( $modal_selector == 'icon' || $modal_selector == 'image' ) {
			if($selector_icon_name || $selector_image) {
				...
				$selector_text_style_sm	= (isset($this->addon->settings->selector_text_size_sm) && $this->addon->settings->selector_text_size_sm) ? 'font-size:' . $this->addon->settings->selector_text_size_sm .'px;' : '';
				...
				$selector_text_style_xs	= (isset($this->addon->settings->selector_text_size_xs) && $this->addon->settings->selector_text_size_xs) ? 'font-size:' . $this->addon->settings->selector_text_size_xs .'px;' : '';
